...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n ecomm
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n ecomm
```
...
```
$ kubectl get svc jhipster-console -n ecomm
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n ecomm
```

and explore the details using

```
$ kubectl get svc exposed-registry -n ecomm
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n ecomm
```
